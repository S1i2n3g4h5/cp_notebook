...
void solve(){
  /*
    secret array - 2*n + 1;
    all 1->n elemnt repeated twice, except of 1 number repeating thrice

    find the positions where this 3rd repeating number occurs
    within 66 queries only
    n <= 1e3;

    ---

    quering the whole array results 0, cuz there is no unique count 
    of elements
