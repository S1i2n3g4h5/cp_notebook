...
void solve(){
  /*
    rock played by "a" players
    scissor played by "b" players
    paper played by "c" players
  ...
  */
    ...
    ll rock = b>=2 ? min(a,c):0ll;
    ll scissor = c>=2 ? min(b,c):0ll;
    ll paper = a>=2 ? min(a,c):0ll;


    ll curr = rock + scissor + paper;
    ll tot = a+b+c;
    tot /= 2;


    cout << max(0ll, min(curr, tot));
    cout << "\n";
