...
RATING_BUCKETS = [
    ...
    ("1600-1900", 1600, 1900),
    ("1900-2100", 1900, 2101),
    ("2100-2500", 2101, 2500),  # 2100 inclusive
    ("2500-3000", 2500, 3000)  # 2100 inclusive
]
...
def plot_tag_barcharts(bucket_to_tag_counter, top_n: int = 25):
    """
...
def main():
    ...
    for label, _, _ in RATING_BUCKETS:
        ...
        for tag, freq in cnt.most_common(25):
